...
func (p *LoginResp) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "login_time", thrift.STRING, 2)
	offset += bthrift.Binary.WriteStringNocopy(buf[offset:], binaryWriter, p.LoginTime)
...
func (p *LoginResp) field2Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("login_time", thrift.STRING, 2)
	l += bthrift.Binary.StringLengthNocopy(p.LoginTime)
...
func (p *ChangePasswordReq) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "old_password", thrift.STRING, 1)
...
func (p *ChangePasswordReq) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("old_password", thrift.STRING, 1)
